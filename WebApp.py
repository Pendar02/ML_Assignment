...
results = {
    ...
    2:[
        ...
        "Moderate depression is also called as an early state of depression and easy to handle than mild depression. You must make sure that you talk to a psychiatrist about the symptoms that you experience. The consumption of medicine like sertraline or paroxetine may be prescribed by your doctor. Make sure that you consume it on time" ],
    3:[
